import {
  ...
  injected,
  mock
} from "./chunk-46TSJ7JZ.js";
import {
  withRetry,
  withTimeout
} from "./chunk-BMXJUWMI.js";
import {
  ResourceUnavailableRpcError,
  SwitchChainError,
  UserRejectedRequestError
} from "./chunk-ZPBY3UJD.js";
import "./chunk-ZG3SD57V.js";
import "./chunk-FVSBVWAL.js";
import "./chunk-PN6XQTEH.js";
import {
  getAddress,
  numberToHex
} from "./chunk-5PJ6JDHQ.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-TAMTFNMW.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-VULJETBY.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-GCQYT77O.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SafeAppsSDK } = await import("./src-DSE3WJ46.js");
        let SDK;
        ...
        const { SafeAppProvider } = await import("./dist-PJIKHZ56.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-6N7Q6MYP.js");
